...
public class MandateCalculator implements ContractCalculator {

    private final SalaryRulesProvider rules;
    public MandateCalculator(SalaryRulesProvider rules){ this.rules = rules; }

    @Override public boolean supports(CalculationInput in){ return in.contractType()== ContractType.MANDATE; }
